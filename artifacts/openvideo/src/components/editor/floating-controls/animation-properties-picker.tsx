...
export function AnimationPropertiesPicker() {
  ...
  const comboPresets = [
    { label: "BVIRAL Zoom 1", value: "comboZoom1" },
    { label: "BVIRAL Zoom 2", value: "comboZoom2" },
    { label: "BVIRAL Pendulum 1", value: "comboPendulum1" },
    { label: "BVIRAL Pendulum 2", value: "comboPendulum2" },
    { label: "BVIRAL Right Distort", value: "comboRightDistort" },
    { label: "BVIRAL Left Distort", value: "comboLeftDistort" },
    { label: "BVIRAL Wobble", value: "comboWobble" },
    { label: "BVIRAL Spinning Top 1", value: "comboSpinningTop1" },
    { label: "BVIRAL Spinning Top 2", value: "comboSpinningTop2" },
    { label: "BVIRAL Sway Out", value: "comboSwayOut" },
    { label: "BVIRAL Bounce 1", value: "comboBounce1" },
    { label: "BVIRAL Sway In", value: "comboSwayIn" },
  ];
          ...
          {typeClip === "Caption" ? (
            ...
            <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
              <TabsList className="grid w-full grid-cols-3">
                ...
                <TabsTrigger value="combo">BVIRAL</TabsTrigger>
              </TabsList>
